...
import com.example.shopeee.databinding.BillingProductsRvItemBinding
...
class BillingProductsAdapter: Adapter<BillingProductsAdapter.BillingProductsViewHolder>() {
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductsRvItemBinding) :
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                Glide.with(itemView).load(billingProduct.product.images[0]).into(imageCartProduct) //put calc in helper class
