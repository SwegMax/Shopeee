...
import com.example.shopeee.ShopeeeApplication
...
class UserAccountViewModel @Inject constructor(
    ...
    fun updateUser(user: User, imageUri: Uri?) {
        ...
        if(imageUri == null){
            ...
            saveUserInformationWithNewImage(user, imageUri) //Jervis trim
        }
    }
        ...
        viewModelScope.launch {
            try {
                val imageBitMap = MediaStore.Images.Media.getBitmap(
                    getApplication<ShopeeeApplication>().contentResolver,
                    imageUri)
